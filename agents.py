...
class RAGRetriever:
    ...
    def retrieve(
        ...
        Falls back to an empty list (caller should handle by using all nodes)
        ...
        try:
            ...
            log.warning("RAGRetriever.retrieve failed (%s) — returning empty list", exc)
            return []
...
class AgentPipeline:
    ...
    def get_relevant_context(
        ...
        # -- Keyword fallback (original behaviour) -----------------------------
        ...
        scored: list[tuple[float, IssueNode]] = []
        for n in nodes:
